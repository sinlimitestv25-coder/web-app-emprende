...
export const spaces: PlatformSpace[] = [
  {
    ...
    email: "natalia@pensandoenti.com",
    plan: "Equipo",
    status: "Activo",
...
export const administrators = [
  { id: "usr_01", name: "Natalia Martínez", email: "natalia@pensandoenti.com", space: "Pensando en ti", spaceId: "NX-000001", role: "Administradora", status: "Activo", lastAccess: "Hoy, 09:42" },
  ...
  { id: "usr_04", name: "Nicolás Vega", email: "nico@pensandoenti.com", space: "Pensando en ti", spaceId: "NX-000001", role: "Empleado", status: "Activo", lastAccess: "Hoy, 08:10" },
];

export const platformEvents = [
  { id: "evt_01", action: "Inicio de sesión", subject: "Natalia Martínez", context: "Pensando en ti · NX-000001", time: "Hace 18 min", tone: "mint" },
